    ...
    <>
      <footer className="bg-white rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased">
        <p className="mb-4 text-sm text-center text-gray-500 sm:mb-0">
          &copy; {currentDate}
          <a> Institut Teknologi Quantum</a>. All rights reserved.
        </p>
        <div className="flex justify-center items-center space-x-1">
          ...
          <div
            id="tooltip-facebook"
            role="tooltip"
            className="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-black bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip"
          >
            Like us on Facebook
